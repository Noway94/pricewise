...
export async function scrapeAmazonProduct(url:string) {
    ...
    try {
        ...
        toLocaleLowerCase() ==='currently unavailable';
        ...
        const stars=parseFloat(extractPrice($('.a-size-base a-color-base'))).toFixed(1)
        
        const description=extractDescription ($)
      

    //    console.log({title,currentPrice,orignalPrice,outOfStock,imageUrls,currency,discountRate,stars})
       
        //construct data objectw ith scraped information
